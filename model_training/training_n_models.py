...
def run_model(num): 
   ...
   # select detector and epoch 
    ...
    if fname == 'global':
        ...
        run_number = detector_type + '_' + epoch + '_' + fname[0:3] + '_3_' + str(num)
    ...
    load_model = True
    load_model_path = '/home3/ebrahim/results/test_detector/cnn/final_models/A_q1_509_val/best_model.h5'
    dense_num = 10
    optim = 'adam'
    eps = 1e-7
    ...
    if (load_model):
        ...
        history = model.fit(X, y, batch_size=batch_size, epochs=epochs, shuffle=True, class_weight=class_weights)
        plot_val = 'acc'   
